...
- NDH governs **human experience**  
- GBS governs **structural stability**  
- ZenAI governs **technical execution**

---

# 2. NDH Governance Layer
...
# 4. ZenAI Platform Layer

ZenAI provides the enterprise-grade substrate:
...
- Secure hosting (on-prem, private cloud)  
- Provider-agnostic model selection  
- REST API integrations  
- Multi-step agentic workflows  

ZenAI ensures scalability, compliance, and operational reliability.

---

# 5. Reference Architecture Flow
...
## Principle 1 — NDH Governs, ZenAI Executes  
NDH defines what must not be violated.  
ZenAI provides the mechanisms to enforce it.

## Principle 2 — GBS Stabilizes the Middle  
GBS ensures NDH invariants survive translation into ZenAI workflows.

## Principle 3 — Trauma-Informed by Design  
Every workflow must be predictable, stable, and non-absorptive.

## Principle 4 — Enterprise-Ready by Default  
ZenAI ensures compliance, security, and scalability.
...
Choose a domain workflow (intake, navigation, appeals).

## Step 2 — NDH Analysis  
Apply NDH invariants and GBS modeling.

## Step 3 — ZenAI Configuration  
Build agents, workflows, privacy classes, and access rules.

## Step 4 — NDH–ZenAI Alignment  
Validate holonomy, predictability, and trauma-safe boundaries.

## Step 5 — Evaluation  
Measure cognitive load, predictability, and compliance.
